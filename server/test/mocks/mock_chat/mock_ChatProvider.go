...
// Chats provides a mock function with given fields: ctx, cid
func (_m *MockChatProvider) Chats(ctx context.Context, cid [][]byte) ([]model.Chat, error) {
	ret := _m.Called(ctx, cid)
...
// MockChatProvider_Chats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Chats'
type MockChatProvider_Chats_Call struct {
	*mock.Call
}

// Chats is a helper method to define mock.On call
//   - ctx context.Context
//   - cid [][]byte
func (_e *MockChatProvider_Expecter) Chats(ctx interface{}, cid interface{}) *MockChatProvider_Chats_Call {
	return &MockChatProvider_Chats_Call{Call: _e.mock.On("Chats", ctx, cid)}
}

func (_c *MockChatProvider_Chats_Call) Run(run func(ctx context.Context, cid [][]byte)) *MockChatProvider_Chats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([][]byte))
	})
	return _c
...
func (_c *MockChatProvider_Chats_Call) Return(_a0 []model.Chat, _a1 error) *MockChatProvider_Chats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockChatProvider_Chats_Call) RunAndReturn(run func(context.Context, [][]byte) ([]model.Chat, error)) *MockChatProvider_Chats_Call {
	_c.Call.Return(run)
	return _c
}
